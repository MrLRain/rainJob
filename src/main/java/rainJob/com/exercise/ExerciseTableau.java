    ...
    public static void main( String[] arguments ) {
        ...
        if ( options.containsKey( "publish" ) ) {
            try {
                ...
                //  Publish the Extract
                publishExtract( options.get( "filename" ), options.get( "test" ), options.get( "datasource-name" ), options.containsKey( "overwrite" ),
                        options.get( "http://localhost/#/projects" ), options.get( "309947442@qq.com" ), options.get( "123456" ), options.get( "site-id" ) );
